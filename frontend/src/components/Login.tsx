...
export const LoginPage: React.FC<LoginPageProps> = ({ onNavigateToSignup, onLoginSuccess, onNavigateHome }) => {
                ...
                <Form onSubmit={handleSubmit}>
                  ...
                  <Form.Group className="mb-3" controlId="formPassword">
                    <div className="d-flex justify-content-between align-items-center mb-1">
                      ...
                      <a href="#forgot" className="text-decoration-none" style={{ fontSize: '0.8rem', color: '#ff007f' }}>Forgot password?</a>
                    </div>
